...
class AdminUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_user" do
    assert_difference('AdminUser.count') do
      post admin_users_url, params: { admin_user: { created_by: @admin_user.created_by, permission: @admin_user.permission, status: @admin_user.status, updated_by: @admin_user.updated_by, user_id: @admin_user.user_id, username: @admin_user.username } }
    end
  ...
  test "should update admin_user" do
    patch admin_user_url(@admin_user), params: { admin_user: { created_by: @admin_user.created_by, permission: @admin_user.permission, status: @admin_user.status, updated_by: @admin_user.updated_by, user_id: @admin_user.user_id, username: @admin_user.username } }
